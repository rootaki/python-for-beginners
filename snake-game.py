...
# very old code (i'll redo this in future, abs not now. this code was created months ago, isn't prefect.)
...
#no copyright, but leave credits in the comment 
# Made in Python by Aki. no copyright. 2022 
